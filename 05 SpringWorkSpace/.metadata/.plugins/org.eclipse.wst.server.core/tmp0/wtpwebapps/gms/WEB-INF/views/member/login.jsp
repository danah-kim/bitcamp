...
<div class="loginContent" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-15" data-genuitec-path="/gms/src/main/webapp/WEB-INF/views/member/login.jsp">
	<form id="loginForm">
