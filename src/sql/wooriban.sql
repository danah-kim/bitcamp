...
-- 데이터 입력
INSERT INTO RPROJECT_TEAM VALUES('ATEAM', 'LetsPlay');
INSERT INTO RPROJECT_TEAM VALUES('HTEAM', '지은이가지은집');
INSERT INTO RPROJECT_TEAM VALUES('CTEAM', '왕거북이');
INSERT INTO RPROJECT_TEAM VALUES('STEAM', '코딩스타');
...
UPDATE MEMBER SET GENDER =
    CASE
        WHEN SUBSTR(SSN, 8,1) LIKE 1 THEN '남자'
        ELSE '여자'
    END
WHERE ROLL IS NULL
;